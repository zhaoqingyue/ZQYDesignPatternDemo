package com.zqy.designpattern.app;
...
public class DesignPatternApp extends Application {
    ...
    private static final String TAG = "DesignPatternApp";
    private static DesignPatternApp sInstance;
    public static Context sContext = null;

    public static DesignPatternApp getInstance() {
        return sInstance;
    }
